...
const SearchBooks = () => {
  //usemutation returns an array. First is the function that triggers the mutation
  // the second is error, loading and data
    ...
    try {
      const { data } = await addBook({
        variables: {
          ...
          link: bookToSave.link || "", // Add any additional fields required
        },
      });
